...
const translations = {
  English: {
    subtitle: "How SANTET collects, uses, and protects your information.",
    ...
    sections: [
      { id: "introduction", title: "Introduction", paragraphs: ["Your privacy matters to us.", "SANTET is committed to protecting personal information and maintaining transparency about how data is collected and used throughout the platform.", "This Privacy Policy explains what information we collect, why we collect it, and how we protect it."] },
      ...
      { id: "authentication", title: "Authentication", paragraphs: ["SANTET supports authentication through Google, GitHub, and email with password.", "Passwords are securely hashed and never stored in plain text.", "Authentication providers may process data according to their own privacy policies."] },
      ...
      { id: "data-intelligence-sources", title: "Data Intelligence Sources", paragraphs: ["The Data Intelligence section aggregates information from publicly available sources such as RSS Feeds, News Websites, GNews API, and YouTube Data API.", "SANTET does not claim ownership of third-party content displayed through these services."] },
      ...
      { id: "your-rights", title: "Your Rights", paragraphs: ["Users may access personal information, update profile details, request account deletion, or request personal data export.", "Requests may be submitted through official SANTET support channels."] },
      { id: "third-party-services", title: "Third-Party Services", paragraphs: ["SANTET integrates with Google Authentication, GitHub Authentication, YouTube Data API, and GNews API.", "These services maintain independent privacy policies and data practices. Users are encouraged to review those policies separately."] },
      ...
      { id: "contact", title: "Contact", paragraphs: ["Questions regarding this Privacy Policy may be directed to the SANTET administration team through official communication channels."] },
    ],
  },
  "Bahasa Indonesia": {
    subtitle: "Bagaimana SANTET mengumpulkan, menggunakan, dan melindungi informasi Anda.",
    ...
    sections: [
      { id: "introduction", title: "Pendahuluan", paragraphs: ["Privasi Anda penting bagi kami.", "SANTET berkomitmen melindungi informasi pribadi dan menjaga transparansi tentang bagaimana data dikumpulkan dan digunakan di seluruh platform.", "Kebijakan Privasi ini menjelaskan informasi yang kami kumpulkan, alasan pengumpulannya, dan cara kami melindunginya."] },
      ...
      { id: "authentication", title: "Autentikasi", paragraphs: ["SANTET mendukung autentikasi melalui Google, GitHub, dan email dengan kata sandi.", "Kata sandi di-hash secara aman dan tidak pernah disimpan dalam bentuk teks biasa.", "Penyedia autentikasi dapat memproses data sesuai kebijakan privasi mereka masing-masing."] },
      ...
      { id: "data-intelligence-sources", title: "Sumber Data Intelligence", paragraphs: ["Bagian Data Intelligence mengagregasi informasi dari sumber publik seperti RSS Feeds, situs berita, GNews API, dan YouTube Data API.", "SANTET tidak mengklaim kepemilikan atas konten pihak ketiga yang ditampilkan melalui layanan ini."] },
      ...
      { id: "your-rights", title: "Hak Anda", paragraphs: ["Pengguna dapat mengakses informasi pribadi, memperbarui detail profil, meminta penghapusan akun, atau meminta ekspor data pribadi.", "Permintaan dapat dikirimkan melalui saluran dukungan resmi SANTET."] },
      { id: "third-party-services", title: "Layanan Pihak Ketiga", paragraphs: ["SANTET terintegrasi dengan Google Authentication, GitHub Authentication, YouTube Data API, dan GNews API.", "Layanan ini memiliki kebijakan privasi dan praktik data independen. Pengguna disarankan meninjau kebijakan tersebut secara terpisah."] },
      ...
      { id: "contact", title: "Kontak", paragraphs: ["Pertanyaan terkait Kebijakan Privasi ini dapat diarahkan kepada tim administrasi SANTET melalui saluran komunikasi resmi."] },
    ],
  },
  Arabic: {
    subtitle: "كيف تجمع SANTET معلوماتك وتستخدمها وتحميها.",
    ...
    sections: [
      { id: "introduction", title: "المقدمة", paragraphs: ["خصوصيتك مهمة بالنسبة لنا.", "تلتزم SANTET بحماية المعلومات الشخصية والحفاظ على الشفافية حول كيفية جمع البيانات واستخدامها عبر المنصة.", "توضح سياسة الخصوصية هذه المعلومات التي نجمعها وسبب جمعها وكيفية حمايتها."] },
      ...
      { id: "authentication", title: "المصادقة", paragraphs: ["تدعم SANTET المصادقة عبر Google وGitHub والبريد الإلكتروني وكلمة المرور.", "يتم تجزئة كلمات المرور بشكل آمن ولا تُخزن كنص عادي.", "قد تعالج مزودو المصادقة البيانات وفقًا لسياسات الخصوصية الخاصة بهم."] },
      ...
      { id: "data-intelligence-sources", title: "مصادر ذكاء البيانات", paragraphs: ["يجمع قسم ذكاء البيانات معلومات من مصادر متاحة للعامة مثل خلاصات RSS ومواقع الأخبار وGNews API وYouTube Data API.", "لا تدعي SANTET ملكية محتوى الجهات الخارجية المعروض عبر هذه الخدمات."] },
      ...
      { id: "your-rights", title: "حقوقك", paragraphs: ["يمكن للمستخدمين الوصول إلى المعلومات الشخصية وتحديث تفاصيل الملف الشخصي وطلب حذف الحساب أو طلب تصدير البيانات الشخصية.", "يمكن إرسال الطلبات عبر قنوات دعم SANTET الرسمية."] },
      { id: "third-party-services", title: "خدمات الجهات الخارجية", paragraphs: ["تتكامل SANTET مع مصادقة Google ومصادقة GitHub وYouTube Data API وGNews API.", "تحتفظ هذه الخدمات بسياسات خصوصية وممارسات بيانات مستقلة. يُنصح المستخدمون بمراجعة تلك السياسات بشكل منفصل."] },
      ...
      { id: "contact", title: "الاتصال", paragraphs: ["يمكن توجيه الأسئلة المتعلقة بسياسة الخصوصية هذه إلى فريق إدارة SANTET عبر قنوات الاتصال الرسمية."] },
    ],
  },
  Japanese: {
    subtitle: "SANTET が情報を収集、利用、保護する方法。",
    lastUpdated: "最終更新",
    readingTime: "読了時間",
    language: "言語",
    toc: "このページ",
    ...
    sections: [
      { id: "introduction", title: "はじめに", paragraphs: ["あなたのプライバシーは私たちにとって重要です。", "SANTET は個人情報を保護し、プラットフォーム全体でデータがどのように収集・利用されるかについて透明性を保つことを約束します。", "このプライバシーポリシーは、収集する情報、収集理由、保護方法を説明します。"] },
      ...
      { id: "authentication", title: "認証", paragraphs: ["SANTET は Google、GitHub、メールとパスワードによる認証をサポートします。", "パスワードは安全にハッシュ化され、平文で保存されることはありません。", "認証プロバイダーは、それぞれのプライバシーポリシーに従ってデータを処理する場合があります。"] },
      ...
      { id: "data-intelligence-sources", title: "データインテリジェンスの情報源", paragraphs: ["データインテリジェンスセクションは、RSS フィード、ニュースサイト、GNews API、YouTube Data API などの公開情報源から情報を集約します。", "SANTET はこれらのサービスを通じて表示される第三者コンテンツの所有権を主張しません。"] },
      ...
      { id: "your-rights", title: "あなたの権利", paragraphs: ["ユーザーは個人情報へのアクセス、プロフィール情報の更新、アカウント削除の請求、個人データのエクスポート請求を行えます。", "請求は SANTET の公式サポートチャネルを通じて提出できます。"] },
      { id: "third-party-services", title: "第三者サービス", paragraphs: ["SANTET は Google Authentication、GitHub Authentication、YouTube Data API、GNews API と連携します。", "これらのサービスは独自のプライバシーポリシーとデータ慣行を有しています。ユーザーはそれらのポリシーを個別に確認することをお勧めします。"] },
      ...
      { id: "contact", title: "お問い合わせ", paragraphs: ["このプライバシーポリシーに関する質問は、公式連絡チャネルを通じて SANTET 管理チームに問い合わせることができます。"] },
    ],
  },
  Korean: {
    subtitle: "SANTET 이 정보를 수집, 사용, 보호하는 방법입니다.",
    lastUpdated: "최종 업데이트",
    readingTime: "읽는 시간",
    language: "언어",
    toc: "이 페이지",
    ...
    sections: [
      { id: "introduction", title: "소개", paragraphs: ["귀하의 개인정보는 중요합니다.", "SANTET 은 개인정보를 보호하고 플랫폼 전반에서 데이터가 어떻게 수집되고 사용되는지 투명하게 설명하는 데 전념합니다.", "본 개인정보 처리방침은 수집하는 정보, 수집 이유, 보호 방법을 설명합니다."] },
      ...
      { id: "authentication", title: "인증", paragraphs: ["SANTET 은 Google, GitHub, 이메일과 비밀번호 인증을 지원합니다.", "비밀번호는 안전하게 해시되며 평문으로 저장되지 않습니다.", "인증 제공자는 자체 개인정보 처리방침에 따라 데이터를 처리할 수 있습니다."] },
      ...
      { id: "data-intelligence-sources", title: "데이터 인텔리전스 출처", paragraphs: ["데이터 인텔리전스 섹션은 RSS 피드, 뉴스 웹사이트, GNews API, YouTube Data API 와 같은 공개 출처의 정보를 집계합니다.", "SANTET 은 이러한 서비스를 통해 표시되는 제3자 콘텐츠의 소유권을 주장하지 않습니다."] },
      ...
      { id: "your-rights", title: "귀하의 권리", paragraphs: ["사용자는 개인정보 접근, 프로필 세부정보 업데이트, 계정 삭제 요청, 개인 데이터 내보내기 요청을 할 수 있습니다.", "요청은 SANTET 공식 지원 채널을 통해 제출할 수 있습니다."] },
      { id: "third-party-services", title: "제3자 서비스", paragraphs: ["SANTET 은 Google Authentication, GitHub Authentication, YouTube Data API, GNews API 와 통합됩니다.", "이들 서비스는 독립적인 개인정보 처리방침과 데이터 관행을 유지합니다. 사용자는 해당 정책을 별도로 검토하는 것이 좋습니다."] },
      ...
      { id: "contact", title: "문의", paragraphs: ["본 개인정보 처리방침에 대한 질문은 공식 통신 채널을 통해 SANTET 관리 팀에 문의할 수 있습니다."] },
    ],
  },
  "Chinese (Simplified)": {
    subtitle: "SANTET 如何收集、使用和保护您的信息。",
    lastUpdated: "最后更新",
    readingTime: "阅读时间",
    language: "语言",
    toc: "在本页",
    ...
    sections: [
      { id: "introduction", title: "引言", paragraphs: ["您的隐私对我们很重要。", "SANTET 致力于保护个人信息，并对整个平台中数据的收集和使用保持透明。", "本隐私政策说明我们收集哪些信息、为何收集以及如何保护这些信息。"] },
      { id: "information-we-collect", title: "我们收集的信息", paragraphs: ["创建账户时，我们可能会收集姓名、电子邮件地址、学习项目、可选头像和可选简介。", "我们只收集提供平台服务和改善用户体验所必需的信息。"] },
      { id: "authentication", title: "认证", paragraphs: ["SANTET 支持通过 Google、GitHub 以及电子邮件和密码进行认证。", "密码会安全哈希存储，绝不会以明文保存。", "认证提供商可能会根据其自身的隐私政策处理数据。"] },
      ...
      { id: "data-intelligence-sources", title: "数据智能来源", paragraphs: ["数据智能部分会汇总来自公开来源的信息，例如 RSS 订阅、新闻网站、GNews API 和 YouTube Data API。", "SANTET 不主张拥有通过这些服务展示的第三方内容。"] },
      ...
      { id: "your-rights", title: "您的权利", paragraphs: ["用户可以访问个人信息、更新个人资料、请求删除账户或请求导出个人数据。", "请求可通过 SANTET 官方支持渠道提交。"] },
      { id: "third-party-services", title: "第三方服务", paragraphs: ["SANTET 与 Google Authentication、GitHub Authentication、YouTube Data API 和 GNews API 集成。", "这些服务拥有独立的隐私政策和数据实践。建议用户分别查看这些政策。"] },
      { id: "policy-updates", title: "政策更新", paragraphs: ["本隐私政策可能会定期更新，以反映平台改进、法律要求或运营变化。", "重大更新将在适当时通过平台通知。"] },
      { id: "contact", title: "联系", paragraphs: ["有关本隐私政策的问题，可通过官方沟通渠道联系 SANTET 管理团队。"] },
    ],
  },
};
...
export default function PrivacyPage() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("santet:privacy-language") as LanguageKey | null;
    if (stored && translations[stored]) setLanguage(stored);
  }, []);

  useEffect(() => {
    localStorage.setItem("santet:privacy-language", language);
  }, [language]);
