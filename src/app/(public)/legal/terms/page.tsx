...
const translations = {
  English: {
    subtitle: "Guidelines and responsibilities for using the SANTET ecosystem.",
    ...
    sections: [
      { id: "welcome", title: "Welcome", paragraphs: ["Welcome to SANTET.", "SANTET is a collaborative technology ecosystem developed by the Faculty of Computer Science at Universitas Saintek Muhammadiyah.", "By accessing or using the platform, you agree to follow these terms and contribute to a safe, respectful, and productive environment."] },
      { id: "using-the-platform", title: "Using the Platform", paragraphs: ["SANTET is designed for learning, collaboration, innovation, research, and community activities.", "Users are expected to use the platform responsibly and in accordance with applicable laws and university regulations."] },
      ...
      { id: "projects-and-contributions", title: "Projects and Contributions", paragraphs: ["Users retain ownership of the content they create.", "By publishing content on SANTET, you grant the platform permission to display, organize, and promote that content within the ecosystem.", "Ownership remains with the original creator."] },
      ...
      { id: "contact", title: "Contact", paragraphs: ["Questions regarding these Terms of Service can be directed to the platform administrators through the official contact channels provided by SANTET."] },
    ],
  },
  "Bahasa Indonesia": {
    subtitle: "Panduan dan tanggung jawab dalam menggunakan ekosistem SANTET.",
    ...
    sections: [
      { id: "welcome", title: "Selamat Datang", paragraphs: ["Selamat datang di SANTET.", "SANTET adalah ekosistem teknologi kolaboratif yang dikembangkan oleh Fakultas Ilmu Komputer Universitas Saintek Muhammadiyah.", "Dengan mengakses atau menggunakan platform ini, Anda setuju untuk mengikuti ketentuan ini dan berkontribusi pada lingkungan yang aman, saling menghargai, dan produktif."] },
      { id: "using-the-platform", title: "Menggunakan Platform", paragraphs: ["SANTET dirancang untuk pembelajaran, kolaborasi, inovasi, riset, dan kegiatan komunitas.", "Pengguna diharapkan menggunakan platform secara bertanggung jawab serta sesuai hukum dan regulasi universitas yang berlaku."] },
      ...
      { id: "projects-and-contributions", title: "Proyek dan Kontribusi", paragraphs: ["Pengguna tetap memiliki konten yang mereka buat.", "Dengan memublikasikan konten di SANTET, Anda memberikan izin kepada platform untuk menampilkan, mengatur, dan mempromosikan konten tersebut dalam ekosistem.", "Kepemilikan tetap berada pada pembuat asli."] },
      ...
      { id: "contact", title: "Kontak", paragraphs: ["Pertanyaan terkait Terms of Service ini dapat diarahkan kepada administrator platform melalui saluran kontak resmi yang disediakan SANTET."] },
    ],
  },
  Arabic: {
    subtitle: "إرشادات ومسؤوليات استخدام نظام SANTET.",
    ...
    sections: [
      { id: "welcome", title: "مرحبًا", paragraphs: ["مرحبًا بك في SANTET.", "SANTET هو نظام تقني تعاوني طورته كلية علوم الحاسوب في Universitas Saintek Muhammadiyah.", "من خلال الوصول إلى المنصة أو استخدامها، فإنك توافق على اتباع هذه الشروط والمساهمة في بيئة آمنة ومحترمة ومنتجة."] },
      { id: "using-the-platform", title: "استخدام المنصة", paragraphs: ["صُممت SANTET للتعلم والتعاون والابتكار والبحث والأنشطة المجتمعية.", "من المتوقع أن يستخدم المستخدمون المنصة بمسؤولية وفقًا للقوانين واللوائح الجامعية المعمول بها."] },
      ...
      { id: "projects-and-contributions", title: "المشاريع والمساهمات", paragraphs: ["يحتفظ المستخدمون بملكية المحتوى الذي ينشئونه.", "من خلال نشر المحتوى على SANTET، فإنك تمنح المنصة إذنًا لعرضه وتنظيمه والترويج له داخل النظام.", "تبقى الملكية للمؤلف الأصلي."] },
      ...
      { id: "contact", title: "الاتصال", paragraphs: ["يمكن توجيه الأسئلة المتعلقة بشروط الخدمة هذه إلى مسؤولي المنصة عبر قنوات الاتصال الرسمية التي يوفرها SANTET."] },
    ],
  },
  Japanese: {
    subtitle: "SANTET エコシステムの利用に関するガイドラインと責任。",
    lastUpdated: "最終更新",
    readingTime: "読了時間",
    language: "言語",
    toc: "このページ",
    ...
    sections: [
      { id: "welcome", title: "ようこそ", paragraphs: ["SANTET へようこそ。", "SANTET は、Universitas Saintek Muhammadiyah の Faculty of Computer Science によって開発された協働型テクノロジーエコシステムです。", "プラットフォームにアクセスまたは利用することで、これらの規約に従い、安全で尊重され生産的な環境に貢献することに同意したことになります。"] },
      { id: "using-the-platform", title: "プラットフォームの利用", paragraphs: ["SANTET は学習、コラボレーション、イノベーション、研究、コミュニティ活動のために設計されています。", "ユーザーは適用される法律および大学規程に従い、責任を持ってプラットフォームを利用することが期待されます。"] },
      ...
      { id: "projects-and-contributions", title: "プロジェクトと貢献", paragraphs: ["ユーザーは自身が作成したコンテンツの所有権を保持します。", "SANTET 上でコンテンツを公開することで、エコシステム内での表示、整理、紹介をプラットフォームに許可することになります。", "所有権は元の作成者に残ります。"] },
      ...
      { id: "contact", title: "お問い合わせ", paragraphs: ["本利用規約に関する質問は、SANTET が提供する公式連絡窓口を通じてプラットフォーム管理者へご連絡ください。"] },
    ],
  },
  Korean: {
    subtitle: "SANTET 생태계 사용에 관한 가이드라인과 책임입니다.",
    lastUpdated: "최종 업데이트",
    readingTime: "읽는 시간",
    language: "언어",
    toc: "이 페이지",
    ...
    sections: [
      { id: "welcome", title: "환영합니다", paragraphs: ["SANTET 에 오신 것을 환영합니다.", "SANTET 은 Universitas Saintek Muhammadiyah Faculty of Computer Science 에서 개발한 협업형 기술 생태계입니다.", "플랫폼에 접근하거나 사용함으로써 귀하는 본 약관을 따르고 안전하며 존중받고 생산적인 환경에 기여することに 동의합니다."] },
      { id: "using-the-platform", title: "플랫폼 사용", paragraphs: ["SANTET 은 학습, 협업, 혁신, 연구, 커뮤니티 활동을 위해 설계되었습니다.", "사용자는 적용되는 법률과 대학 규정에 따라 책임감 있게 플랫폼을 사용해야 합니다."] },
      ...
      { id: "projects-and-contributions", title: "프로젝트 및 기여", paragraphs: ["사용자는 자신이 만든 콘텐츠의 소유권을 유지합니다.", "SANTET 에 콘텐츠를 게시하면 생태계 내에서 해당 콘텐츠를 표시, 정리, 홍보할 권한을 플랫폼에 부여하는 것입니다.", "소유권은 원래 작성자에게 남습니다."] },
      ...
      { id: "contact", title: "문의", paragraphs: ["본 이용약관에 대한 질문은 SANTET 이 제공하는 공식 연락처를 통해 플랫폼 관리자에게 문의할 수 있습니다."] },
    ],
  },
  "Chinese (Simplified)": {
    subtitle: "使用 SANTET 生态系统的指南和责任。",
    lastUpdated: "最后更新",
    readingTime: "阅读时间",
    language: "语言",
    toc: "在本页",
    ...
    sections: [
      { id: "welcome", title: "欢迎", paragraphs: ["欢迎使用 SANTET。", "SANTET 是由 Universitas Saintek Muhammadiyah 的 Faculty of Computer Science 开发的协作型技术生态系统。", "通过访问或使用本平台，您同意遵守这些条款，并为安全、尊重且富有成效的环境做出贡献。"] },
      { id: "using-the-platform", title: "使用平台", paragraphs: ["SANTET 旨在服务于学习、协作、创新、研究和社区活动。", "用户应按照适用法律和大学规章负责任地使用平台。"] },
      ...
      { id: "projects-and-contributions", title: "项目与贡献", paragraphs: ["用户保留其创建内容的所有权。", "通过在 SANTET 上发布内容，您授予平台在生态系统内展示、整理和推广该内容的权限。", "所有权仍归原始创作者所有。"] },
      ...
      { id: "contact", title: "联系", paragraphs: ["有关本服务条款的问题，可通过 SANTET 提供的官方联系渠道联系平台管理员。"] },
    ],
  },
};
...
export default function TermsPage() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("santet:terms-language") as LanguageKey | null;
    if (stored && translations[stored]) setLanguage(stored);
  }, []);

  useEffect(() => {
    localStorage.setItem("santet:terms-language", language);
  }, [language]);
